...
while True:
    ...
    if menu == "1":
        ...
        if remove_char not in user_word:
            print("Character does not exist in user word.")
        else:
            user_word = user_word.replace(remove_char, "")
    elif menu == "2":
        ...
        if user_index.isnumeric:
            ...
            print("Unfortunately you have made an invalid selection.")
    elif menu == "3":
        user_word = input("Please enter the new word you would like to edit: ")
